...
| M4 | Web app on Render staging: sign-in, onboarding, feeds, reports, alerts, billing pages | Render access to the GitHub repo; Clerk keys; env vars on Render | in progress: live at content-story.onrender.com with Clerk sign-in. Redesigned around onboarding: 3-step setup (who you are, creators and subreddits we already cover, brands) with a live count of stories your picks bring in; sidebar app with Stories (For you / All / Saved, search, platform filter, filter by anyone you follow), Following (one-tap follow from the catalog, add anyone by link), Reports, Billing (Razorpay top-ups), Settings, Admin; landing page and legal drafts; trial 1,000 credits, 10 creators/subreddits, 3 brands; 17/17 product checks. Not yet: alerts and digests, team invites, subscription checkout, daily collection |
